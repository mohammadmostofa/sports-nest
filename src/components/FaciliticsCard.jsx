...
<div className="absolute inset-0 bg-gradient-to-t from-[#260a62] via-[#070114]/80 to-[#070114]/20 opacity-0 transition-opacity duration-500 group-hover:opacity-95" />      </div>
