...
const LoginPage = () => {
  ...
  return (
    <div className="py-10 flex items-center justify-center bg-gray-100/5 px-4">
      <Card className="w-full max-w-sm px-10 py-10 bg-violet-800/10 rounded-2xl shadow-xl border border-violet-900/40">
          ...
          <TextField name="password" isRequired>
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="w-full pl-10 px-10 py-2 border border-white/20 bg-white/10 text-white placeholder-gray-300 rounded-lg"
              />
